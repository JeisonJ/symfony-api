...
use App\Vicander\Service\VicanderValidator;
...
abstract class BaseHandler
{
    ...
    /* codigos respuesta sesiones */
    const CODE_UNAUTHORIZED = 401;
    const CODE_EXPIRED_SESSION = 40;
    const CODE_BAD_CREDENTIAL = 41;
    const CODE_NOT_AUTHENTICATED = 42;
    const CODE_NOT_TOKEN_SESSION= 43;
    const CODE_TOKEN_SESSION_NOT_ACTIVE= 44;
    const CODE_IP_CHANGED = 45;
    const CODE_USER_NOT_ACTIVE= 46;
    const CODE_USER_NOT_EXISTS= 47;
    const CODE_USER_NOT_TOKEN_PASSWORD= 48;
    const CODE_USER_NOT_ACCESS_URL= 49;


    /* codigos respuesta registro */
    const CODE_USER_EXISTS = 450;

    /* codigos respuesta agencia */
    const CODE_AAVV_NO_EXISTS = 470;
    const CODE_AAVV_NO_ACTIVE = 471;
    ...
    /* Codigos de respuesta roles*/
     const DELETE_ROL= 23;
     const ROL_NOT_EXISTS= 24;
    ...
    final public function processHandler() : void
    {
        try {
            ...
            $validator = new VicanderValidator();
    ...
    /**
     * Set headers del Handler
     *
     * @param $headers;
     * @return BaseHandler
     */
    public function setHeaders(array $headers) : BaseHandler
    {
