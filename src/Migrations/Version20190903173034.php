 ...
 */
final class Version20190903173034 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, rol_id INT NOT NULL, name VARCHAR(255) NOT NULL, age INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_8D93D6494BAB96C ON "user" (rol_id)');
        $this->addSql('CREATE TABLE rol (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
